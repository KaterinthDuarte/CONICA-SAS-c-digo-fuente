    ...
    <main>
        ...
        <div class="container col-lg-3">
            <form action="Controlador">
                ...
                <br> 
                <center><a href="registro.jsp">¿No tienes cuenta? Registrate</a> </center>
               <br> 
               
                      <center> <a class="small text-muted">Terminos de uso CONICA S.A.S</a> <br> 
                          <a class="small text-muted">Politicas de privacidad CONICA S.A.S</a>  </center>
            </form>
        </div>
